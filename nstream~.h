...
#define DEFAULT_AUDIO_CHANNELS 8	    /* nax. number of audio channels we support */
#define DEFAULT_AUDIO_BUFFER_SIZE 1024	/* number of samples in one audio block */
//#define DEFAULT_CBUF_SIZE DEFAULT_AUDIO_BUFFER_SIZE * DEFAULT_AUDIO_CHANNELS * sizeof(t_float)
#define DEFAULT_CBUF_SIZE DEFAULT_AUDIO_BUFFER_SIZE * DEFAULT_AUDIO_CHANNELS * sizeof(t_sample)
...
#ifdef _WINDOWS
__inline static float nstream_float(float f)
#else
inline static float nstream_float(float f)
#endif
{
    union
    {
...
/* swap 32bit long int */
#ifdef _WINDOWS
__inline static long nstream_long(long n)
#else
inline static long nstream_long(long n)
#endif
{
...
#ifdef _WINDOWS
__inline static long nstream_short(long n)
#else
inline static short nstream_short(short n)
#endif
{
...
#define SF_AAC    31    /* AAC encoding using*/
...
//convertion to LE
#define toles(A)  ((((short)(A) & 0xff00) >> 8) | \
                   (((short)(A) & 0x00ff) << 8))
#define tolel(A)  ((((long)(A) & 0xff000000) >> 24) | \
                   (((long)(A) & 0x00ff0000) >> 8)  | \
                   (((long)(A) & 0x0000ff00) << 8)  | \
